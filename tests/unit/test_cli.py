...
class TestCli(unittest.TestCase):
    def test_get_ips_list(self):
        ...
        self.assertEquals(cli._get_ips_list('123.123.123.123 , 123.123.123.124 , 152.245.112.152'),
                          ['123.123.123.123', '123.123.123.124', '152.245.112.152'])
        self.assertEquals(cli._get_ips_list('333.200.1.21'), [], "[[333.200.1.21]] is a not valid ip format.")
        self.assertEquals(cli._get_ips_list('200.1.21'), [], "[[200.1.21]] is a not valid ip format.")
        self.assertEquals(cli._get_ips_list('1233.200.1.21'), [], "[[1233.200.1.21]] is a not valid ip format.")
